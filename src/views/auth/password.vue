<template>
    ...
    <top-component></top-component>
      ...
      <my-input
        ...
        <div class='error' v-if='errors.has("new_password_confirmation")' >{{ errors.first("new_password_confirmation") }}</div>

      <mt-button size="large" type='primary' class='btn-top' @click.native='confirmPassword' :disabled='btnDisabled'>确定</mt-button>
    ...
    confirmPassword() {
      this.$validator.validate().then((valid) => {
        if(valid) {
          ...
          this.$store.dispatch('user/password', this.validateForm)
          .then((res) => {
